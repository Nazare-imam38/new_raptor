...
/***************************************************************************
 NewRapt
                                 A QGIS plugin
 Add a new raptor nest, create buffer and imapct table
 Generated by Plugin Builder: http://g-sherman.github.io/Qgis-Plugin-Builder/
                              -------------------
        begin                : 2024-03-16
        git sha              : $Format:%H$
        copyright            : (C) 2024 by NUST
        email                : imamsyed716@gmail.com
 ***************************************************************************/
...
from .new_raptor_dialog import NewRaptDialog
import os.path
...
class NewRapt:
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('NewRapt', message)
    ...
    def initGui(self):
        ...
        for lyr in mc.layers():
            ...
            for lyr in missing_layer:
                msg + = '\n{}',format(lyr)
            QMessageBox.critial(self.dlg,"Missing Layers",msg)
